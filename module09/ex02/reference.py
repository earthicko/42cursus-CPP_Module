...
# Output: Sorted array
# # #
def merge_insertion_sort(A: list):
...
def convert_args_to_int(args):
    # Exclude the first argument (which is the script name), convert to integers and store in a list
    int_list = [int(arg) for arg in args[1:]]
    return int_list

if __name__ == "__main__":
    int_list = convert_args_to_int(sys.argv)
    print(int_list)
